...
//Никита написал красивый класс для пагинации, теперь он мой
...
class _PaginationBuilderState<T>
  ...
  Stream<UnmodifiableListView<T>> _loadData(int page) async* {
    ...
    //если закончились данные, значит нам больше не нужно слушать скролл
    //или бесконечно стучимся в callback по каждому движению
    if(!hasNext){
