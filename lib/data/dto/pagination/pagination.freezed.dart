...
class _$_Pagination<T> with DiagnosticableTreeMixin implements _Pagination<T> {
  const _$_Pagination({required this.info, required final List<T> results})
      : _results = results;
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'Pagination<$T>'))
