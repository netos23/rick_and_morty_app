...
_$_Character _$$_CharacterFromJson(Map<String, dynamic> json) => _$_Character(
      ...
      location: CharLocation.fromJson(json['location'] as Map<String, dynamic>),
...
_$_CharLocation _$$_CharLocationFromJson(Map<String, dynamic> json) =>
    _$_CharLocation(
      name: json['name'] as String,
      url: json['url'] as String,
    );

Map<String, dynamic> _$$_CharLocationToJson(_$_CharLocation instance) =>
    <String, dynamic>{
      'name': instance.name,
      'url': instance.url,
    };
